...
import { ArrowRight, ShieldCheck, Sparkles, ShoppingBag, LayoutDashboard, Lock, Play, TrendingUp, CheckCircle, Cpu, Zap, Bot, Code } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 pt-12 pb-16 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center text-left">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-white leading-tight">
              Mercury — AI-Native <br />
              <span className="bg-gradient-to-r from-blue-400 via-indigo-300 to-emerald-400 bg-clip-text text-transparent">
                Merchant Commerce Gateway
              </span>
            </h1>

            <p className="text-base sm:text-lg text-slate-300 max-w-2xl leading-relaxed font-sans">
              Ordinary websites are built for human eyes, not AI agents. Mercury is the infrastructure layer that makes a merchant sellable, understandable, and transactable to autonomous AI buyers under explicit policy rules and Razorpay payment authorization.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 text-left">
          <TiltCard className="p-6 rounded-2xl border border-slate-800 bg-slate-900/60 backdrop-blur-md">
            ...
            <h3 className="text-sm font-bold text-white mb-2">Agentic Catalog Protocol</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              Exposes machine-readable JSON-LD feeds and OpenAPI 3.0 endpoints enabling third-party AI agents (ChatGPT, Claude, AutoGPT) to inspect products, stock, and payment specifications.
            </p>
          </TiltCard>
          ...
          <TiltCard className="p-6 rounded-2xl border border-slate-800 bg-slate-900/60 backdrop-blur-md">
            ...
            <h3 className="text-sm font-bold text-white mb-2">Autonomous Merchant Growth Agent</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              Monitors purchase affinity vectors across historical order items to deliver evidence-based dynamic co-purchase upsells, increasing AOV by +16.6%.
            </p>
          </TiltCard>
          ...
          <TiltCard className="p-6 rounded-2xl border border-slate-800 bg-slate-900/60 backdrop-blur-md">
            ...
            <h3 className="text-sm font-bold text-white mb-2">Air-Gapped Policy Engine & Razorpay</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              Separates LLM reasoning from financial execution. Financial caps enforce automatic boundaries, route out-of-bounds requests to human approval, and execute HMAC-verified Razorpay payments.
            </p>
          </TiltCard>
        </div>
